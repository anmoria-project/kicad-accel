...
bus_i2c = [
    ...
    DriverType('i2c_master[x].irq_m2s', bus_master, 'output',        ['i2c_slave[x].irq_m2s'], 1, False),
    DriverType('i2c_master[x].irq_s2m', bus_master, 'input',         ['i2c_slave[x].irq_s2m'], 1, False),
    ...
    DriverType('i2c_slave[x].irq_m2s',  bus_slave,  'input',         ['i2c_master[x].irq_m2s'], 1, False),
    DriverType('i2c_slave[x].irq_s2m',  bus_slave,  'output',        ['i2c_master[x].irq_s2m'], 1, False),
]
...
bus_usbc = [
    ...
    DriverType('usbc_conn[x].cc1',   bus_conn,   'bidirectional',['usbc_master[x].cc1'], 2, False),
    DriverType('usbc_conn[x].cc2',   bus_conn,   'bidirectional',['usbc_master[x].cc2'], 2, False),
    ...
    DriverType('usbc_master[x].cc1',   bus_master,   'bidirectional', ['usbc_conn[x].cc1'],  2, False),
    DriverType('usbc_master[x].cc2',   bus_master,   'bidirectional', ['usbc_conn[x].cc2'],  2, False),
